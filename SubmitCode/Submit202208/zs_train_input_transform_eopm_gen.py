...
def init_dict(model_transform, grad_dict):
    """
        Init a dict that will be used to store the gradient of the generator model.
        :param model_transform: The generator.
        :grad_dict: Dict to store the gradients.
...
def sum_grads(model_transform, grad_dict):
    """
        ...
        :param model_transform: The generator.
        :param grad_dict: Dict to store the gradients of the generator.
...
def mean_grads(grad_dict, nums):
    """
        Sum all of the gradients.
        :param grad_dict: Dict to store the gradients of the generator.
        :param nums: How many perturbed models used to calculate EOPM.
...
def transform_train(trainloader, testloader, arch, dataset, in_channels, precision, checkpoint_path, force, device, fl, ber, pos, seed=0,):
    ...
    print('========== Check folder: save_dir: {} =========='.format(cfg.save_dir))
    print('========== Random Training: {}'.format(cfg.totalRandom))
    ...
    for epoch in range(cfg.epochs):
        ...
        # Store the generator and the learning curve.
