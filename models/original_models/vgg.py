...
def vgg(cfg,input_channels,classes,batch_norm):
    model = VGG(make_layers(cfgs[cfg], in_channels = input_channels, batch_norm=batch_norm), classes=classes)
    return model
